...
namespace CardGames
{
    public class SnapGame
    {
        public static void LoadResources()
        {
            ...
            SwinGame.LoadSoundEffect("Start","SwinGameStart.wav");
            SwinGame.LoadSoundEffect("Error","error.wav");
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.White,"GameFont", 0, 3);
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.White,"GameFont", 0, 450);
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.White,"GameFont", 0, 470);
